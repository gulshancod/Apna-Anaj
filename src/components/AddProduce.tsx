...
export const AddProduce: React.FC<AddProduceProps> = ({
  ...
  const cropOptions = [
  { label: '🌾 MP Sharbati Gehu / Wheat (गेहूं)', value: 'Wheat', defaultPrice: 48 },
  { label: '🍚 Aromatic Basmati Rice (चावल)', value: 'Rice', defaultPrice: 95 },
  { label: '🌱 Desi Chana Dal / Gram (चना दाल)', value: 'Gram', defaultPrice: 88 },
  { label: '🌾 Desi Bajra / Pearl Millet (बाजरा)', value: 'Bajra', defaultPrice: 36 },
  ...
  { label: '🥕 Crisp Red Carrots (गाजर)', value: 'Carrot', defaultPrice: 38 },
  { label: '🫛 Sweet Green Peas (हरी मटर)', value: 'Peas', defaultPrice: 45 },
  { label: '🫑 Green Capsicum (शिमला मिर्च)', value: 'Capsicum', defaultPrice: 40 },
  { label: '🥒 Tender Lauki / Bottle Gourd (लौकी)', value: 'Bottle Gourd', defaultPrice: 26 },
  { label: '🍆 Desi Bharta Baingan (बैंगन)', value: 'Brinjal', defaultPrice: 32 },
  { label: '🥒 Desi Crisp Kheera (खीरा)', value: 'Cucumber', defaultPrice: 28 },
  { label: '🥦 Snow White Cauliflower (फूलगोभी)', value: 'Cauliflower', defaultPrice: 35 },
  { label: '🥬 Tender Desi Palak (पालक)', value: 'Spinach', defaultPrice: 18 },
  { label: '🌿 Desi Methi / Fenugreek (मेथी)', value: 'Methi', defaultPrice: 20 },
  { label: '🌿 Fresh Dhaniya / Coriander (धनिया)', value: 'Coriander', defaultPrice: 15 },
  { label: '🥭 Ratnagiri Alphonso Mango (हापुस आम)', value: 'Mango', defaultPrice: 240 },
  { label: '🥛 Pure Gir Cow A2 Milk (दूध)', value: 'Milk', defaultPrice: 44 }
 ];
